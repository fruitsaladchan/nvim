  ...
  if not M._keys then
    M._keys = {
      ...
      },
      {
        ...
        deps = "textDocument/implementation",
      },
      {
        "gt",
        function()
      ...
      { "K", vim.lsp.buf.hover, desc = "Hover", deps = "textDocument/hover" },
      {
        ...
        desc = "Signature Help",
        deps = "textDocument/signatureHelp",
      },
      {
        "<C-k>",
        vim.lsp.buf.signature_help,
      ...
      { "<leader>cC", vim.lsp.codelens.refresh, desc = "Codelens", deps = "textDocument/codeLens" },
      {
        ...
        desc = "LSP Symbols",
        deps = "textDocument/documentSymbol",
      },
      {
        "<leader>fS",
        function()
